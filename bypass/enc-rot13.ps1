...
try{
   ...
   ElseIf($Output -iMatch '^(ps1|.psm1|.psd1)$')
   {
...
try{echo `"`$rdata`"|Invoke-Expression}catch{Write-Host `"convertion: `$rdata`" -ForeGroundColor Blue};Start-Sleep -Miliseconds 1400
")
