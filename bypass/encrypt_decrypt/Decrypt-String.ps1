...
# write-host "  => Brute force secretKey last byte." -ForegroundColor Yellow
# [string]$lastbyteranges = @("242,243,244,245,246,247,248,249,250,251,252,253,254,255")
# $Token = $lastbyteranges.Split(',');$BruteMe = "True"
# ForEach($RandomByte in $Token)
# {
#
[Byte[]]$SecretKey = 117,9,103,192,133,20,53,149,83,95,108,34,82,224,226,220,56,68,133,120,139,241,176,239,171,54,231,205,83,57,51,$RandomByte
$DisplaySecret = "117,9,103,192,133,20,53,149,83,95,108,34,82,224,226,220,56,68,133,120,139,241,176,239,171,54,231,205,83,57,51,$RandomByte"
