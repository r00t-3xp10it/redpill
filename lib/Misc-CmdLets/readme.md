...
|Cmdlet Name|Description|Privileges|Notes|
|---|---|---|---|
|[Mitre-T1202](https://github.com/r00t-3xp10it/redpill/blob/main/lib/Misc-CmdLets/Mitre-T1202.ps1)| MITRE ATT&CK T1202: Indirect Command Execution|User Land|\*\*\*|

<br />

**Download cmdLet:**
```powershell
iwr -uri "https://raw.githubusercontent.com/r00t-3xp10it/redpill/main/lib/Misc-CmdLets/Mitre-T1202.ps1" -OutFile "Mitre-T1202.ps1"
```
