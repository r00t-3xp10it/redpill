...
.EXAMPLE
   PS C:\> .\Invoke-ShortUrl.ps1 -ServerPort '127.0.0.1:8080'
   URI: http://127.0.0.1:8080/Update-KB5005101.html

.EXAMPLE
   PS C:\> .\Invoke-ShortUrl.ps1 -ServerPort '192.168.1.72:8087' -PayloadName 'update.html'
   URI: http://192.168.1.72:8087/update.html

.EXAMPLE
   PS C:\> .\Invoke-ShortUrl.ps1 -PayloadName 'fake-update.zip' -Verb 'true'
   URI: http://192.168.1.72:8087/fake-update.zip ( verbose outputs )

.EXAMPLE
   PS C:\> .\Invoke-ShortUrl.ps1 -serverport '127.0.0.1:8081' -startserver 'true'
   URI: http://127.0.0.1:8081/Update-KB5005101.html ( start http.server )

.EXAMPLE
   PS C:\> .\Invoke-ShortUrl.ps1 -Payloadname 'mozlz4-win32.exe' -startserver 'true'
   URI: http://192.168.1.72:8087/mozlz4-win32.exe ( start http.server )

.INPUTS
   None. You cannot pipe objects into Invoke-ShortUrl.ps1
