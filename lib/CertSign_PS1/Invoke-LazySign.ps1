...
.EXAMPLE
   PS C:\> .\Invoke-LazySign.ps1 -Subject "LazySign" -Target "target.exe" -Domain "microsoft.com"

.EXAMPLE
   PS C:\> .\Invoke-LazySign.ps1 -Subject "LazySignCN" -Target "target.exe" -Domain "microsoft.com" -Password "Passw0rd!"
...
write-host "----------                                -------"
write-host "6DE90730783ADCA4796F537C203B8A4351C8295B  CN=$RandSubject"
write-host ""
#>
