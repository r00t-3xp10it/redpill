...
If($Action -iMatch '^(create)$')
{
   ...
   .NOTES
      Parameter -secure switch allow us to modify our
      generic password in plain text to SecureString PS
      Object, but doing so we can no longer decode it.
   ...
   If($Secure.IsPresent)
   {
      ...
      .SYNOPSIS
         Author: @r00t-3xp10it
         Helper - Create Secure password [Secure String PS Object]
