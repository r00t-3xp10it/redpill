...
{
   write-host "[vault] Error: Wrong parameter -action '$Action' input.`n" -ForegroundColor Red
   return
}
...
{
   write-host "[vault] Error: Cmdlet requires 'VaultSvc' service running.`n" -ForegroundColor Red
   return
}
