...
If($Action -ieq "verbose")
{
   ...
   ForEach($DriverName in $FinalDrivers)
   {
      ...
      If($DriverName -iMatch '^(edrsensor.sys|bdfndisf6.sys|bdfwfpf.sys|avc3.sys|avckf.sys)$')
      {
         ## Adding values to output DataTable!
         $DriversTable.Rows.Add("$DriverName",         ## Driver Name
                                "$Dversion",           ## File Version
      ...
      If($DriverName -iMatch '^(mbamwatchdog.sys|mbae.sys|mbae64.sys)$')
      {
         ## Adding values to output DataTable!
         $DriversTable.Rows.Add("$DriverName",         ## Driver Name
                                "$Dversion",           ## File Version
      ...
      If($DriverName -iMatch '^(ssfmonm.sys|pwipf6.sys)$')
      {
         ## Adding values to output DataTable!
         $DriversTable.Rows.Add("$DriverName",         ## Driver Name
                                "$Dversion",           ## File Version
