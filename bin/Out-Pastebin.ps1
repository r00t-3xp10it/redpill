...
.NOTES
   PasteBin accepts the max of 20 pastes by day on 'free' accounts.
...
.INPUTS
   None. You cannot pipe objects into Out-Pastebin.ps1

.OUTPUTS
   * Out-PasteBin cmdlet by BlankSecurity
   * PastebinDeveloperKey : 1ab4a1a4e39c94db4f653127a45e7159
     + PastebinUsername   : pedro_testing
     + PasteTitle         : oki
...
Function Out-Pastebin
{
    ...
    Begin
    {
        ...
        write-host "B" -ForegroundColor DarkYellow -NoNewline;write-host "lank" -ForegroundColor DarkGray -NoNewline;
    ...
    End
    {
        ...
        Try{
           ...
           write-host "* Error when uploading to pastebin ..`n" -ForegroundColor Red
        }
