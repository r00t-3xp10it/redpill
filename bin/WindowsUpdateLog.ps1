...
If($Action -ieq "query")
{
   ...
   .SYNOPSIS
      Author: @r00t-3xp10it
      Helper - Enumerate ETL files of sellected directory
   ...
   .OUTPUTS
      ...
      ----                 -------------         ------ ----                                                                                               
      -a----        08/05/2022     01:13          53248 WindowsUpdate.20220508.004335.137.1.etl                                                            
      -a----        08/05/2022     02:29          45056 WindowsUpdate.20220508.021143.862.1.etl                                                            
      -a----        08/05/2022     03:04          53248 WindowsUpdate.20220508.023103.424.1.etl 
   #>
   ...
   #List directory and Delete duplicated entry names
   Get-ChildItem -Path "$ETLPath" -Recurse -Force|sort|Get-Unique
   exit #Exit @WindowsUpdateLog
}
