...
If($Action -ieq "Contacts")
{
   ...
   Else
   {
      ...
      $TerMinalOutPut | Select-Object FirstName,MiddleName,LastName,CompanyName,Department,JobTitle,Anniversary,Birthday,Email1Address,BusinessAddressCity,HomeAddressStreet,HomeAddressCity,HomeAddressState,HomeTelephoneNumber | Format-list | Out-String -Stream | Select-Object -Skip 2
   }
}
