...
.NOTES
   ...
   Param -LowAccuracy switch increases the default cmdlet Regex scan success
...
.EXAMPLE
   PS C:\> .\Find-strings.ps1 -Path "$Env:TMP" -LowAccuracy
