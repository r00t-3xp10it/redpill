...
[CmdletBinding(PositionalBinding=$false)] param(
   ...
   [string]$Exclude=".zip|.tar|.rar|.7z|.pdf|.img|.iso|.dll|.db|.mp(3|4)|.png|.jpg|.gif|.msi|.exe|.ico|.wav",
...
If($Exclude -iNotMatch ".zip|.tar|.rar|.7z|.pdf|.img|.iso|.dll|.db|.mp(3|4)|.png|.jpg|.gif|.msi|.exe|.ico|.wav")
{
   ...
   $Exclude = ".zip|.tar|.rar|.7z|.pdf|.img|.iso|.dll|.db|.mp(3|4)|.png|.jpg|.gif|.msi|.exe|.ico|.wav"+"$Exclude" -join ''
}
