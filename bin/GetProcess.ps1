...
If($GetProcess -ieq "Enum" -or $GetProcess -ieq "Kill"){
    ...
    ElseIf($GetProcess -ieq "Enum" -and $ProcessName -ne "false")
    {
       ...
       Get-Process $RawProcName -EA SilentlyContinue | Select-Object Id,PriorityClass,Name,ProcessName,Description,Product,Company,StartTime,ProductVersion,Path,MainWindowTitle,HasExited,Responding |
