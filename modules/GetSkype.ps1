...
.SYNOPSIS
   ...
   Thanks: @nyxgeek for the http-ntlm auth endpoints
   Tested Under: Windows 10 (19042) x64 bits
   Required Dependencies: Microsoft.Lync.Model 2013 SDK
...
.EXAMPLE
   PS C:\> Import-Module -Name C:\Users\pedro\Coding\redpill\PowerSkype.ps1 -Force
   PS C:\> Get-SkypeContacts | ft -AutoSize
   PS C:\> Get-SkypeDomainUsers | ft -AutoSize

.INPUTS
   None. You cannot pipe objects into PowerSkype.ps1
...
.LINK
   ...
   https://www.netspi.com/blog/technical/cloud-penetration-testing/attacking-federated-skype-powershell
#>
...
If(-not(Get-Module -Name Microsoft.Lync.Model)){
    try{
       ...
       Write-Warning "Microsoft.Lync.Model not available, download and install the Lync 2013 SDK`nURLLINK: http://www.microsoft.com/en-us/download/details.aspx?id=36824`n"
       Write-Host "";Remove-Item -Path "$Env:TMP\GetSkype.ps1" -Force
       break
    }
}
