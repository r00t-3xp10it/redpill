...
.EXAMPLE
	...
	backgroundTaskHost   1076 Primary No       N/A                   SKYNET\pedro
	backgroundTaskHost   1960 Primary No       N/A                   SKYNET\pedro
	...
	svchost              4292 144     No       SecurityImpersonation SKYNET\pedro
	svchost              4292 7704    No       SecurityImpersonation SKYNET\pedro
	svchost              4292 1404    No       SecurityImpersonation SKYNET\pedro
	svchost              4464 Primary No       N/A                   SKYNET\pedro
	svchost              4556 Primary No       N/A                   SKYNET\pedro
...
#>
    ...
    If($IsClientAdmin -ieq "True"){
        ...
        echo "`n   [error] This module requires Administrator privileges to run!`n" > $Env:TMP\fdppor.log
        Get-Content -Path "$Env:TMP\fdppor.log"
        Remove-Item -Path "$Env:TMP\fdppor.log" -Force
