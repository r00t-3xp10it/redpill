...
function New-ExploitTable {
    ...
    $Global:ExploitTable.Rows.Add("HiveNigthmare Local Elevation of Privileges","N/A","CVE-2021-36934","https://github.com/r00t-3xp10it/redpill/blob/main/bypass/Invoke-HiveNightmare.ps1")
