...
.EXAMPLE
   ...
   Get-Paths 1∫ @arg accepts Everyone:(FileSystemRigths) value.

.EXAMPLE
   PS C:\> Get-Paths FullControl BUILTIN\Users
   SYNTAX: Get-Paths <FileSystemRigths> <IdentityReference>
   Get-Paths 2∫ @arg accepts the Group Name (Everyone|BUILTIN\Users)
...
$CmdletVersion = "v1.3.8"    ## Sherlock CmdLet develop version number
...
$UserImput = $args[0] ## User Imputs
   ...
   $FindGroup = whoami /groups|findstr /C:"Everyone" /C:"Todos" /C:"Tout" /C:"Alle" /C:"Y—Å–µ" /C:"Semua" /C:"Allemaal" /C:"Toate" /C:"Bce" /C:"Svi"|Select-Object -First 1
...
[int]$Count = 0 ## Loop counter
   ...
   .EXAMPLE
      PS C:\> Get-Paths Modify
      SYNTAX: Get-Paths <FileSystemRigths>
      Get-Paths 1ÔøΩ arg accepts Everyone:(FileSystemRigths) value.

   .EXAMPLE
      PS C:\> Get-Paths FullControl BUILTIN\Users
      Get-Paths 2ÔøΩ arg accepts the Group Name (Everyone|BUILTIN\Users)
