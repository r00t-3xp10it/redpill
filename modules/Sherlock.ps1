...
## Var declarations
$CveDataBaseId = "27"        ## 27 CVE's entrys available ($dATAbASE)
$CmdletVersion = "v1.3.10"    ## Sherlock CmdLet develop version number
$CVEdataBase = "15/01/2022"  ## Global $dATAbASE (CVE) last update date
...
function New-ExploitTable {
    ...
    $Global:ExploitTable.Rows.Add("PrintNigthmare Remote Elevation of Privileges","N/A","CVE-2021-1675","https://github.com/calebstewart/CVE-2021-1675")
}
