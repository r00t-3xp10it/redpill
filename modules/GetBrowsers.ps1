...
function BROWSER_RECON {
    ...
    If($MInvocation -iMatch 'IE'){$id = "True";$fd = "False";$cd = "False"}
    If($MInvocation -iMatch 'Chrome'){$id = "False";$fd = "False";$cd = "True"}
    If($MInvocation -iMatch 'Firefox'){$id = "False";$fd = "True";$cd = "False"}
    If($MInvocation -iMatch 'MSEdgeHTM'){$id = "True";$fd = "False";$cd = "False"}
    If($MInvocation -iMatch 'Opera'){$id = "-> $MInvocation <-";$fd = "False";$cd = "False"}
    If(-not($MInvocation) -or $MInvocation -eq $null){$id = "{Null}";$fd = "{Null}";$cd = "{Null}"}Else{}
