...
.EXAMPLE
   ...
   Creates a new obfuscated client (revshell.ps1), disable av samples submition, encode tcp
   data flow and creates Setup.vbs download crandle that spawn a UAC gui to run elevated.
