...
.NOTES
   ...
   Remark: Parameter -action 'rawcat' will use papacat as client (payload)
   while -action 'obfuscate' param creates a new obfuscated client (payload)
   
   create a new reverse tcp cmdlet while
   -action 'o
