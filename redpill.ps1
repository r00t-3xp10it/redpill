...
$HelpParameters = @"
   ...
   .EXAMPLE
      PS C:\> powershell -file redpill.ps1 -GetCounterMeasures Verbose -stringsearch 'true'
      Search for strings 'Defender|antimalware' on drivers File Description

   .EXAMPLE
      PS C:\> powershell -file redpill.ps1 -GetCounterMeasures 'enum' -stringsearch 'true' -string 'Defender'
